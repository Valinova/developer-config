---
name: full-docs
description: Performs a deep documentation audit with cross-family adversarial validation. Use only when the user explicitly invokes "full docs" or "full-docs".
