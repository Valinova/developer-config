...
Produce a phased implementation plan from the agreed direction. The active Pi
model is the orchestrator — Grok 4.6 by default (harness seats in
`model-selection.md`); review selection follows "External calls".
